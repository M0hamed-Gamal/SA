        ...
        return (
            <>
                <div className="jumbotron">
                    <Container>
                        <h1 className="display-4">Space Anchor</h1>
                        <p className="lead">This is place for you to start a  project or support other Anchors projects! </p>
                    ...
                    <Container>
                        <Row className="pt-5">
                            <Col sm lg={4} className="text-center mb-5">
                                ...
                                <p className="text-muted content">with Space Anchor, your ideas can be visualize and become reality.</p>
                            </Col>
                            <Col sm lg={4} className="text-center mb-5">
